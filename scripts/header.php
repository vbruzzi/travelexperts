...
<html>
    <head>
        ...
        <!-- JQUERY, POPPER.JS AND BOOSTRAP JS FILE-->
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <header class="container">
                <a class="navbar-brand" href="index.php"><img src="media/logo.png" alt="Travel Experts Logo"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="packages.php">Vacation Package <span
