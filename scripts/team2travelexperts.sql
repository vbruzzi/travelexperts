...
--
-- Host: 127.0.0.1
-- Generation Time: April 4, 2019 at 4:14pm
...
--
-- Database: `team2travelexperts`
--

CREATE DATABASE IF NOT EXISTS `team2travelexperts` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `team2travelexperts`;
...
INSERT INTO `agents` (`AgentId`, `UserId`, `AgtPosition`, `AgencyId`) VALUES
(1, 2, '3', 1),
(2, 3, '2', 1),
(3, 4, '1', 1),
(4, 5, '2', 1),
...
INSERT INTO `customers` (`CustomerId`, `UserId`, `AgentId`) VALUES
(104, 104, 4),
(105, 105, 3),
(106, 106, 1),
(107, 107, 4),
...
--
-- Table structure for table `featuredpackages`
--

DROP TABLE IF EXISTS `featuredpackages`;
CREATE TABLE IF NOT EXISTS `featuredpackages` (
  `PackageId` int(11) NOT NULL,
  `Feature` int(11) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `featuredpackages`
--

INSERT INTO `featuredpackages` (`PackageId`, `Feature`) VALUES
(1, 1),
(1, 2),
(1, 3),
(2, 1),
...
--
-- Table structure for table `packageoptions`
--

DROP TABLE IF EXISTS `packageoptions`;
CREATE TABLE IF NOT EXISTS `packageoptions` (
...
--
-- Dumping data for table `packageoptions`
--

INSERT INTO `packageoptions` (`OptionId`, `Feature`) VALUES
(1, '5 Days/4 Nights'),
(2, 'Luxury sedan included'),
(3, 'Fantastic Views hike');
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  `PkgDesc` varchar(450) DEFAULT NULL,
  `PkgBasePrice` decimal(9,2) NOT NULL,
  `PkgAgencyCommission` decimal(9,2) DEFAULT NULL,
  `Featured` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 is FALSE',
...
INSERT INTO `packages` (`PackageId`, `PkgName`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `PkgBasePrice`, `PkgAgencyCommission`, `Featured`) VALUES
(1, 'Caribbean New Year', '2017-12-25', '2017-01-04', 'Cruise the Caribbean & Celebrate the New Year.', '4800.00', '400.00', 0),
(2, 'Polynesian Paradise', '2016-12-12', '2016-12-20', '8 Day All Inclusive Hawaiian Vacation', '3000.00', '310.00', 0),
(3, 'Asian Expedition', '2016-05-14', '2016-05-28', 'Airfaire, Hotel and Eco Tour.', '2800.00', '300.00', 0),
(4, 'European Vacation', '2016-11-01', '2016-11-14', 'Euro Tour with Rail Pass and Travel Insurance', '2800.00', '280.00', 0),
(5, 'Bhutan', '2019-04-01', '2019-04-30', 'Bhutan is known for its monasteries, fortresses (or dzongs) and dramatic landscapes that range from subtropical plains to steep mountains and valleys. Ideal for a Zen trip, with a peace and calm that you don''t experience anywhere else. Seek inner peace with a transcendent that uses oils from the Himalayas. You can also challenge yourself to trek to places like the Tiger Nest, a cliffside Buddhist temple.', '3000.00', '300.00', 0),
(6, 'Azores', '2019-05-01', '2019-05-31', 'The Azores are known for outdoor adventure along with historical and cultural charm. These islands have something for everyone: vineyards, volcanic crater lakes, world-class whale watching, hot springs, UNESCO protected landscapes, natural swimming pools, thermal springs, diving, surfing, waterfalls - this destination is one big playground that''s rich in natural beauty.', '3100.00', '310.00', 1),
(7, 'Botswana', '2019-05-01', '2019-05-31', 'Botswana is your destination for unforgettable adventures and authentic experiences. Try glamping in the heart of Chobe National Park in beautiful lodges with amazing wildlife viewing in the savannah. Perfect way to disconnect from your routine and connect with wildlife and nature, but still have the opportunity to enjoy the kind of comfort and luxury that makes a difference in a trip of a lifetime.', '3200.00', '320.00', 1),
(8, 'Copenhagen', '2019-04-01', '2019-04-30', 'Copenhagen is the epitome of Scandi cool. A city of endless visual pleasure; a place where even the most mundane activities are laced with a sense of quiet wonder and delight. It''s also one of the globe''s greenest, cleanest, most sustainable urban centers. From Viking treasures in a former prince''s palace to iconic Danish chairs in a one-time baroque hospital, Copenhagen''s cultural offerings are rich and eclectic.', '3300.00', '330.00', 0),
(9, 'Rio de Janeiro', '2019-06-01', '2019-06-30', 'Rio de Janeiro welcomes visitors with its scenic vistas and lively festivals. The extravagant Carnival celebration held each February or March includes days of masquerade balls, parades and parties. Those looking for a well-rounded trip to Rio should check out the towering Christ the Redeemer statue, explore the 340-acre Jardim Botânico, and spend some time lazing on Ipanema or Copacabana beach.', '3400.00', '340.00', 1),
(10, 'Tokyo', '2019-06-01', '2019-06-30', 'Tokyo is Japan''s capital and the world''s most populous metropolis. The city offers a seemingly unlimited choice of shopping, entertainment, culture and dining. The city''s history can be appreciated in its many excellent museums, historic temples and gardens. Contrary to common perception, Tokyo also offers a number of attractive green spaces in the city center and within relatively short train rides at its outskirts.', '3500.00', '350.00', 1),
(11, 'Abu Simbel', '2019-04-01', '2019-04-30', 'Abu Simbel is undisputedly one of the world''s most breathtaking monuments. The two temples are dedicated to Ramses II and his favourite wife Nefertari. The most remarkable feature is that the construction is oriented in a way that twice a year, the morning sun rays shine through the length of the inner temple cave and illuminate the statues of the four gods seated at the end of the cave.', '3600.00', '360.00', 0),
(12, 'Angkor Wat', '2019-07-01', '2019-07-31', 'Angkor Wat is one of the most popular temples in Cambodia. Originally, a Hindu temple it gradually transformed into a Buddhist temple. Built by King Suryavarman the Second, it''s a classic example of Khmer school of architecture. Famed for being the only temple, which stands oriented in the west direction, tourists can only drop their jaws at the grandeur and the beauty.', '3700.00', '370.00', 0),
(13, 'Parthenon', '2019-07-01', '2019-07-31', 'The Parthenon in Athens is the most famous surviving building of Ancient Greece and one of the most famous buildings in the world. You can almost feel the history in the air. It has stood atop the Acropolis of Athens for nearly 2,500 years and was built to give thanks to Athena, the city''s patron goddess. Throughout its long life, it has also been a treasury, a fortress, a church, and a mosque.', '3800.00', '380.00', 0);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `Country` varchar(16) NOT NULL DEFAULT 'Canada',
...
INSERT INTO `users` (`UserId`, `Username`, `Password`, `FirstName`, `MiddleNameInitials`, `LastName`, `Address`, `City`, `Province`, `Country`, `Postal`, `Email`, `Phone`, `Role`) VALUES
(2, 'JDelton', 'CHANGE', 'Janet', NULL, 'Delton', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'janet.delton@travelexperts.com', '1231231234', 2),
(3, 'JLisle', 'CHANGE', 'Judy', NULL, 'Lisle', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'judy.lisle@travelexperts.com', '1231231234', 2),
(4, 'DReynolds', 'CHANGE', 'Dennis', 'C.', 'Reynolds', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'dennis.reynolds@travelexperts.com', '1231231234', 2),
(5, 'JCoville', 'CHANGE', 'John', NULL, 'Coville', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'john.coville@travelexperts.com', '1231231234', 2),
(6, 'FSmith', 'CHANGE', 'Fred', 'J', 'Smith', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'fred@travelexperts.com', '1231231234', 2),
(7, 'BDixon', 'CHANGE', 'Bruce', 'J.', 'Dixon', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'bruce.dixon@travelexperts.com', '1231231234', 2),
(8, 'BJones', 'CHANGE', 'Beverly', 'S.', 'Jones', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'beverly.jones@travelexperts.com', '1231231234', 2),
(9, 'JMerrill', 'CHANGE', 'Jane', NULL, 'Merrill', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'jane.merrill@travelexperts.com', '1231231234', 2),
(10, 'BPeterson', 'CHANGE', 'Brian', 'S.', 'Peterson', '123 Travel Ave.', 'Calgary', 'AB', 'Canada', 'T5T 5T5', 'brian.peterson@travelexperts.com', '1231231234', 2),
(104, 'LEnison', 'CHANGE', 'Laetia', NULL, 'Enison', '144-61 87th Ave, NE', 'Edmonton', 'AB', 'Canada', 'T2J 6B6', 'GET EMAIL', '4032557865', 1),
(105, 'AMoskowitz', 'CHANGE', 'Angel', NULL, 'Moskowitz', '320 John St., NE', 'Calgary', 'AB', 'Canada', 'T2J 7E3', 'amoskowitz@home.com                               ', '4036409874', 1),
(106, 'JOlvsade', 'CHANGE', 'Judith', NULL, 'Olvsade', '29 Elmwood Ave.,', 'Calgary', 'AB', 'Canada', 'T2Z 3M9', 'jolvsade@aol.com                                  ', '4036861598', 1),
(107, 'CMierzwa', 'CHANGE', 'Catherine', NULL, 'Mierzwa', '22-70 41st St.,NW', 'Calgary', 'AB', 'Canada', 'T2Z 2Z9', 'cmierzwa@msn.com                                  ', '4036404563', 1),
(108, 'JSethi', 'CHANGE', 'Judy', NULL, 'Sethi', '63 Stratton Hall, SW', 'Calgary', 'AB', 'Canada', 'T1Y 6N4', 'judysehti@home.com                                ', '4036204789', 1),
(109, 'LWalter', 'CHANGE', 'Larry', NULL, 'Walter', '38 Bay 26th ST. #2A, NE', 'Calgary', 'AB', 'Canada', 'T2J 6B6', 'lwalter@aol.com                                   ', '4032845588', 1),
(114, 'WLaporte', 'CHANGE', 'Winsome', NULL, 'Laporte', '268 E.3rd St, SW', 'Calgary', 'AB', 'Canada', 'T1Y 6N4', 'GET EMAIL', '4032844565', 1),
(117, 'NKuehn', 'CHANGE', 'Nancy', NULL, 'Kuehn', '44-255 9th St., SW', 'Calgary', 'AB', 'Canada', 'T1Y 6N5', 'GET EMAIL', '4032843211', 1),
(118, 'HLopez', 'CHANGE', 'Hiedi', NULL, 'Lopez', '168 Rowayton Ave, NW', 'Calgary', 'AB', 'Canada', 'T3A 4ZG', 'hlopez@aol.com                                    ', '4035901587', 1),
(119, 'MAbdou', 'CHANGE', 'Mardig', NULL, 'Abdou', '160-04 32nd Ave., SW', 'Calgary', 'AB', 'Canada', 'T2P 2G7', 'GET EMAIL', '4032251952', 1),
(120, 'RAlexander', 'CHANGE', 'Ralph', NULL, 'Alexander', '2054 73rd St, SW', 'Calgary', 'AB', 'Canada', 'T2P 2G7', 'GET EMAIL', '4032256547', 1),
(121, 'SPineda', 'CHANGE', 'Sean', NULL, 'Pineda', '3 Salem Rd., NW', 'Calgary', 'AB', 'Canada', 'T2K 3E3', 'spineda@hotmail.com                               ', '4036864444', 1),
(122, 'JLippen', 'CHANGE', 'Julita', NULL, 'Lippen', '51-76 VanKleeck St., NW', 'Calgary', 'AB', 'Canada', 'T2K 6C5', 'jlippen@cadvision.co                              ', '4035901478', 1),
(123, 'PRadicola', 'CHANGE', 'Pierre', NULL, 'Radicola', '322 Atkins Ave., SE', 'Calgary', 'AB', 'Canada', 'T3G 2C6', 'pradicola@home.com                                ', '4036867536', 1),
(127, 'GAung', 'CHANGE', 'Gary', NULL, 'Aung', '135-32 Louis Blvd, NE', 'Calgary', 'AB', 'Canada', 'T2V 2K5', 'GET EMAIL', '4037501587', 1),
(128, 'JRunyan', 'CHANGE', 'Jeff', NULL, 'Runyan', '109-15 Queens Blvd., NE', 'Calgary', 'AB', 'Canada', 'T2V 2K6', 'jrunyan@aol.com                                   ', '4036201122', 1),
(130, 'LOates', 'CHANGE', 'Lula', NULL, 'Oates', '11A Emory St., NE', 'Calgary', 'AB', 'Canada', 'T3E 3Z4', 'loates@aol.com                                    ', '4036861587', 1),
(133, 'JReed', 'CHANGE', 'James', NULL, 'Reed', '109-621 96th St, NE', 'Calgary', 'AB', 'Canada', 'T3E 4A1', 'jreed@aol.com                                     ', '4037201155', 1),
(135, 'MMasser', 'CHANGE', 'Michellexxxxxxxxxxxxxx', NULL, 'Masser', '379 Ovington Ave, NE', 'Calgary', 'AB', 'Canada', 'T2J 2S9', 'mmasser@aol.com                                   ', '4035908522', 1),
(138, 'JSmith', 'CHANGE', 'John', NULL, 'Smith', '45 Plaza St. West #2D, NE', 'Calgary', 'AB', 'Canada', 'T3E 5C7', 'johnSmith@hotmail.co                              ', '4032837896', 1),
(139, 'AGarshman', 'CHANGE', 'Angelo', NULL, 'Garshman', '82 Western Ave., NE', 'Calgary', 'AB', 'Canada', 'T3E 5C8', 'GET EMAIL', '4032696541', 1),
(140, 'DBaltazar', 'CHANGE', 'Derrick', NULL, 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'AB', 'Canada', 'T3E 5C9', 'GET EMAIL', '4037502547', 1),
(141, 'RBoyd', 'CHANGE', 'Robert', NULL, 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'AB', 'Canada', 'T3E 5C5', 'GET EMAIL', '4037509512', 1),
(142, 'MWaldman', 'CHANGE', 'Monica', NULL, 'Waldman', '257 Depot Rd., NE', 'Calgary', 'AB', 'Canada', 'T2J 6P3', 'mwaldman@aol.com                                  ', '4032844566', 1),
(143, 'GBiers', 'CHANGE', 'Gerard', NULL, 'Biers', '205 19th St., NE', 'Calgary', 'AB', 'Canada', 'T2J 6B6', 'GET EMAIL', '4037506578', 1),
(144, 'zz', 'CHANGE', 'z', NULL, 'z', 'z', 'z', 'Z', 'Canada', 'Z1Z1Z1', 'z@z.zz', '2222222222', 1);
